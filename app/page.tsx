          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="text-white space-y-6">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button asChild size="lg" className="border-white text-white hover:bg-gray-100">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <h3 className="text-xl font-semibold mb-2">Bilingual Approach</h3>
              <p className="text-gray-600">
                Learn mathematics in both English and Chinese to reinforce language skills
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <h3 className="text-xl font-semibold mb-2">Problem-Solving Focus</h3>
              <p className="text-gray-600">
                Develop critical thinking through mathematical challenges in multiple languages
              </p>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-600">Learn from experts fluent in both Chinese and advanced mathematics</p>
            </div>
